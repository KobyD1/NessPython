...
class productPage():
    ...
    def set_product_details(self):
        ...
        with allure.step("Trying to set product details by drop down"):
            ...
            drop_down_amount = len(
                drop_down_elements)  # handling cases of inconsist amount of drop down at diffrent  products
            ...
            with allure.step("Creating image for selected item"):
    ...
    def add_to_cart(self):
        ...
        with allure.step("Adding to cart"):
            ...
            timestamp = datetime.now().strftime("%d-%H-%M-%S")
            self.page.screenshot(path=f"./pom_ebay/images/cart_{timestamp}.png")
